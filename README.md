...
- 🗂️ **Smart Auto-Grouping**: Automatically organizes tabs into customizable categories or sorts them by their domain base as soon as they open.
- 🧹 **Tab Cleanup & Hibernation**: Quickly close duplicate or inactive tabs, and hibernate background tabs to save system memory.
...
4. Click **Load unpacked** and select the root directory of this repository (`TabMaster-Pro`).

## 🛠️ Usage

1. **Popup Menu**: Click the extension icon in your browser toolbar to access quick actions, tab cleanup tools, and view your saved sessions.
2. **Settings Page**: Click the gear icon in the popup to dive into the comprehensive Settings Dashboard. Here, you can define custom categories, manage URL matching rules, configure your theme, and adjust auto-grouping behaviors.
