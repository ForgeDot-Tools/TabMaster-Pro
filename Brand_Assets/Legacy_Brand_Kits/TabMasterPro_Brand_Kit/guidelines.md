# TabMaster Pro Branding Kit

This folder contains all the official branding assets for TabMaster Pro.
...
- **Gradient Start (Accent):** Purple `#6c63ff`
- **Gradient End:** Cyan `#00d4ff`
